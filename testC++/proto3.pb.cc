...
extern PROTOBUF_INTERNAL_EXPORT_proto3_2eproto ::PROTOBUF_NAMESPACE_ID::
    internal::SCCInfo<0>
        scc_info_User_proto3_2eproto;
...
static void InitDefaultsscc_info_User_proto3_2eproto() {
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_User_proto3_2eproto = {
    {ATOMIC_VAR_INIT(
         ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized),
     0, 0, InitDefaultsscc_info_User_proto3_2eproto},
    {}};

static void InitDefaultsscc_info_UserList_proto3_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<1> scc_info_UserList_proto3_2eproto =
    {{ATOMIC_VAR_INIT(
          ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized),
      1, 0, InitDefaultsscc_info_UserList_proto3_2eproto},
     {
         &scc_info_User_proto3_2eproto.base,
     }};

static ::PROTOBUF_NAMESPACE_ID::Metadata file_level_metadata_proto3_2eproto[2];
static constexpr ::PROTOBUF_NAMESPACE_ID::EnumDescriptor const**
    file_level_enum_descriptors_proto3_2eproto = nullptr;
static constexpr ::PROTOBUF_NAMESPACE_ID::ServiceDescriptor const**
    file_level_service_descriptors_proto3_2eproto = nullptr;

const ::PROTOBUF_NAMESPACE_ID::uint32
    TableStruct_proto3_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(
        protodesc_cold) = {
        ~0u,  // no _has_bits_
        ...
        PROTOBUF_FIELD_OFFSET(::User, interests_),
        ~0u,  // no _has_bits_
        PROTOBUF_FIELD_OFFSET(::UserList, _internal_metadata_),
        ~0u,  // no _extensions_
        ~0u,  // no _oneof_case_
        ~0u,  // no _weak_field_map_
        PROTOBUF_FIELD_OFFSET(::UserList, users_),
};
...
const char descriptor_table_protodef_proto3_2eproto[] PROTOBUF_SECTION_VARIABLE(
    protodesc_cold) =
    "\n\014proto3.proto\"4\n\004User\022\014\n\004name\030\001 "
    "\001(\t\022\013\n\003"
    "age\030\002 \001(\005\022\021\n\tinterests\030\003 \003(\t\" "
    "\n\010UserList"
    "\022\024\n\005users\030\001 "
    "\003(\0132\005.User2I\n\013UserService\022\027\n"
    "\007GetUser\022\005.User\032\005.User\022!\n\tListUsers\022\t.Us"
    "erList\032\t.UserListb\006proto3";
static const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable* const
    descriptor_table_proto3_2eproto_deps[1] = {};
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase* const
    descriptor_table_proto3_2eproto_sccs[2] = {
        &scc_info_User_proto3_2eproto.base,
        &scc_info_UserList_proto3_2eproto.base,
};
static ::PROTOBUF_NAMESPACE_ID::internal::once_flag
    descriptor_table_proto3_2eproto_once;
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable
    descriptor_table_proto3_2eproto = {
        false,
        false,
        descriptor_table_protodef_proto3_2eproto,
        "proto3.proto",
        185,
        &descriptor_table_proto3_2eproto_once,
        descriptor_table_proto3_2eproto_sccs,
        descriptor_table_proto3_2eproto_deps,
        2,
        0,
        schemas,
        file_default_instances,
        TableStruct_proto3_2eproto::offsets,
        file_level_metadata_proto3_2eproto,
        2,
        file_level_enum_descriptors_proto3_2eproto,
        file_level_service_descriptors_proto3_2eproto,
};

// Force running AddDescriptors() at dynamic initialization time.
static bool dynamic_init_dummy_proto3_2eproto =
...
User::User(::PROTOBUF_NAMESPACE_ID::Arena* arena)
    : ::PROTOBUF_NAMESPACE_ID::Message(arena), interests_(arena) {
  SharedCtor();
  RegisterArenaDtor(arena);
  // @@protoc_insertion_point(arena_constructor:User)
}
User::User(const User& from)
    : ::PROTOBUF_NAMESPACE_ID::Message(), interests_(from.interests_) {
...
void User::SetCachedSize(int size) const { _cached_size_.Set(size); }
...
size_t User::ByteSizeLong() const {
  ...
  // repeated string interests = 3;
  total_size +=
      1 * ::PROTOBUF_NAMESPACE_ID::internal::FromIntSize(interests_.size());
...
void User::MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
  ...
  const User* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<User>(&from);
  if (source == nullptr) {
...
bool User::IsInitialized() const { return true; }
...
UserList::UserList(::PROTOBUF_NAMESPACE_ID::Arena* arena)
    : ::PROTOBUF_NAMESPACE_ID::Message(arena), users_(arena) {
  SharedCtor();
  RegisterArenaDtor(arena);
  // @@protoc_insertion_point(arena_constructor:UserList)
}
UserList::UserList(const UserList& from)
    : ::PROTOBUF_NAMESPACE_ID::Message(), users_(from.users_) {
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(
      from._internal_metadata_);
...
void UserList::SharedDtor() { GOOGLE_DCHECK(GetArena() == nullptr); }
...
void UserList::SetCachedSize(int size) const { _cached_size_.Set(size); }
  ...
  for (unsigned int i = 0,
    ...
    target =
        ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::InternalWriteMessage(
            1, this->_internal_users(i), target, stream);
  }
...
void UserList::MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
  ...
  const UserList* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<UserList>(&from);
  if (source == nullptr) {
...
bool UserList::IsInitialized() const { return true; }
...
template <>
PROTOBUF_NOINLINE ::User* Arena::CreateMaybeMessage<::User>(Arena* arena) {
  return Arena::CreateMessageInternal<::User>(arena);
}
template <>
PROTOBUF_NOINLINE ::UserList* Arena::CreateMaybeMessage<::UserList>(
    Arena* arena) {
