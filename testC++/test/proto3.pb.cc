...
extern PROTOBUF_INTERNAL_EXPORT_proto3_2eproto ::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<1> scc_info_Person_proto3_2eproto;
extern PROTOBUF_INTERNAL_EXPORT_proto3_2eproto ::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_Person_PhoneNumber_proto3_2eproto;
namespace tutorial {
...
static void InitDefaultsscc_info_AddressBook_proto3_2eproto() {
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<1> scc_info_AddressBook_proto3_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 1, 0, InitDefaultsscc_info_AddressBook_proto3_2eproto}, {
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<1> scc_info_Person_proto3_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 1, 0, InitDefaultsscc_info_Person_proto3_2eproto}, {
      &scc_info_Person_PhoneNumber_proto3_2eproto.base,}};

static void InitDefaultsscc_info_Person_PhoneNumber_proto3_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_Person_PhoneNumber_proto3_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_Person_PhoneNumber_proto3_2eproto}, {}};
...
const char descriptor_table_protodef_proto3_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\014proto3.proto\022\010tutorial\"\333\001\n\006Person\022\014\n\004n"
...
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_proto3_2eproto_sccs[3] = {
  &scc_info_AddressBook_proto3_2eproto.base,
  &scc_info_Person_proto3_2eproto.base,
  &scc_info_Person_PhoneNumber_proto3_2eproto.base,
};
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_proto3_2eproto = {
  false, false, descriptor_table_protodef_proto3_2eproto, "proto3.proto", 295,
...
void Person_PhoneNumber::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_Person_PhoneNumber_proto3_2eproto.base);
  number_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  type_ = 1;
}
...
void AddressBook::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_AddressBook_proto3_2eproto.base);
}
