...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable
    descriptor_table_proto3_2eproto;
class User;
...
PROTOBUF_NAMESPACE_OPEN
template <>
::User* Arena::CreateMaybeMessage<::User>(Arena*);
template <>
::UserList* Arena::CreateMaybeMessage<::UserList>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
...
class User PROTOBUF_FINAL
    : public ::PROTOBUF_NAMESPACE_ID::
          Message /* @@protoc_insertion_point(class_definition:User) */ {
 public:
  inline User() : User(nullptr){};
  virtual ~User();

  User(const User& from);
  User(User&& from) noexcept : User() { *this = ::std::move(from); }
  ...
  static inline const User* internal_default_instance() {
    return reinterpret_cast<const User*>(&_User_default_instance_);
  }
  ...
  inline User* New() const final { return CreateMaybeMessage<User>(nullptr); }
 ...
 public:
  ...
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>& interests()
      const;
...
class UserList PROTOBUF_FINAL
    : public ::PROTOBUF_NAMESPACE_ID::
          Message /* @@protoc_insertion_point(class_definition:UserList) */ {
 public:
  inline UserList() : UserList(nullptr){};
  virtual ~UserList();

  UserList(const UserList& from);
  UserList(UserList&& from) noexcept : UserList() { *this = ::std::move(from); }
  ...
  static inline const UserList* internal_default_instance() {
    return reinterpret_cast<const UserList*>(&_UserList_default_instance_);
  }
 ...
 public:
  ...
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<::User>* mutable_users();
 ...
 public:
  ...
  ::User* add_users();
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<::User>& users() const;
...
inline const std::string& User::_internal_name() const { return name_.Get(); }
...
inline void User::unsafe_arena_set_allocated_name(std::string* name) {
  GOOGLE_DCHECK(GetArena() != nullptr);
  if (name != nullptr) {
  } else {
  }
...
// int32 age = 2;
inline void User::clear_age() { age_ = 0; }
...
// repeated string interests = 3;
inline int User::_internal_interests_size() const { return interests_.size(); }
inline int User::interests_size() const { return _internal_interests_size(); }
inline void User::clear_interests() { interests_.Clear(); }
inline std::string* User::add_interests() {
  // @@protoc_insertion_point(field_add_mutable:User.interests)
  return _internal_add_interests();
}
inline const std::string& User::_internal_interests(int index) const {
  return interests_.Get(index);
}
inline const std::string& User::interests(int index) const {
  // @@protoc_insertion_point(field_get:User.interests)
  return _internal_interests(index);
}
inline std::string* User::mutable_interests(int index) {
  // @@protoc_insertion_point(field_mutable:User.interests)
  return interests_.Mutable(index);
}
inline void User::set_interests(int index, const std::string& value) {
  // @@protoc_insertion_point(field_set:User.interests)
  interests_.Mutable(index)->assign(value);
}
inline void User::set_interests(int index, std::string&& value) {
  // @@protoc_insertion_point(field_set:User.interests)
  interests_.Mutable(index)->assign(std::move(value));
}
inline void User::set_interests(int index, const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  interests_.Mutable(index)->assign(value);
  // @@protoc_insertion_point(field_set_char:User.interests)
}
inline void User::set_interests(int index, const char* value, size_t size) {
  interests_.Mutable(index)->assign(reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_set_pointer:User.interests)
}
inline std::string* User::_internal_add_interests() { return interests_.Add(); }
inline void User::add_interests(const std::string& value) {
  interests_.Add()->assign(value);
  // @@protoc_insertion_point(field_add:User.interests)
}
inline void User::add_interests(std::string&& value) {
  interests_.Add(std::move(value));
  // @@protoc_insertion_point(field_add:User.interests)
}
inline void User::add_interests(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  interests_.Add()->assign(value);
  // @@protoc_insertion_point(field_add_char:User.interests)
}
inline void User::add_interests(const char* value, size_t size) {
  interests_.Add()->assign(reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_add_pointer:User.interests)
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>&
User::interests() const {
  // @@protoc_insertion_point(field_list:User.interests)
  return interests_;
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>*
User::mutable_interests() {
  // @@protoc_insertion_point(field_mutable_list:User.interests)
  return &interests_;
}
...
// repeated .User users = 1;
inline int UserList::_internal_users_size() const { return users_.size(); }
inline int UserList::users_size() const { return _internal_users_size(); }
inline void UserList::clear_users() { users_.Clear(); }
...
inline ::User* UserList::_internal_add_users() { return users_.Add(); }
